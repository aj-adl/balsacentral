...
global $bcent_sb_pos, $bcent_hide_post_meta;
get_header(); ?>
  <div id="content"<?php if ( $bcent_sb_pos == 'left' ) echo (' class="content-right"'); ?> role="main">
    ...
    if (have_posts()) :
		...
		<div id="post-<?php the_ID(); post_class(); ?>">
            ...
            <?php if($bcent_hide_post_meta != 'true') {?>
                <div class="entry-meta"><?php balsacentral_attachment_meta(); ?></div>
            <?php } // Attachment Meta ?>
            ...
            <?php the_content( __( 'Read more &rarr;', 'balsacentral' ) ); ?>
		</div><!-- .entry -->
		<?php endwhile;
		else : ?>
    ...
    <div class="navigation">
        <div class="nav-previous"><?php previous_post_link( '%link', '<span class="meta-nav">' . _x( '&larr;', 'Previous post link', 'balsacentral' ) . '</span> Previous Post' ); ?></div>
        <div class="nav-next"><?php next_post_link( '%link', 'Next post<span class="meta-nav">' . _x( '&rarr;', 'Next post link', 'balsacentral' ) . '</span> Next Post' ); ?></div>
    </div><!-- .navigation -->
</div><!-- #content -->
<?php get_sidebar(); ?>
</div><!-- #primary .wrap -->
