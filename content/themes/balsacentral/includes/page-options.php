...
$page_options = array(
	...
	"sidebar_a" => array(
		"id" => "sidebar_a",
		"title" => __( 'Create an exclusive sidebar for this page.', 'balsacentral' ),
		"type" => "checkbox",
		"description" => __( 'Check to create an exclusive sidebar for this page.', 'balsacentral' ) ),

	"sidebar_h" => array(
		"id" => "sidebar_h",
		"title" => __( 'Create an exclusive Header Widget Area for this page.', 'balsacentral' ),
		"type" => "checkbox",
		"description" => __( 'Check to create an exclusive Header Sidebar for this page. <br/><br/>On checking these options, a new Widget Area will be created in the name of this page. Once you publish or update this page, the new sidebar will appear inside the dropdown menu. You can select that new sidebar and update the page again. You can remove the sidebar by unchecking these options.', 'balsacentral' ) ),

	"hr1" => array(	"type" => "hr"),

	"info2" => array(
		"type" => "heading",
		"description" => __( 'Portfolio and Blog Options', 'balsacentral' ) ),

	"category" => array(
		"id" => "category",
		"title" => __( 'Category IDs to fetch Portfolio or Blog Posts', 'balsacentral' ),
		"type" => "text",
		"description" => __( 'Enter a category ID, or IDs separated by commas, from which you wish to show posts. Use this option if you are using a Portfolio or Blog template.', 'balsacentral' ) ),

	"post_per_page" => array(
		"id" => "post_per_page",
		"title" => __( 'Posts per page', 'balsacentral' ),
		"type" => "text",
		"description" => __( 'The number of posts to show per page.', 'balsacentral' ) ),

	"hr2" => array(	"type" => "hr"),

	"info3" => array( "type" => "heading",
		"description" => __( 'Other Settings', 'balsacentral' ) ),
	...
	"hide_secondary" => array(
		"id" => "hide_secondary",
		"title" => __( 'Check to hide secondary widget area on this page.', 'balsacentral' ),
		"type" => "checkbox")
);
