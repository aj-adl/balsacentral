...
class balsacentral_Popular_Posts extends WP_Widget {
	function balsacentral_Popular_Posts() {
		$widget_ops = array( 'classname' => 'balsacentral_popular_entries', 'description' => __( 'List popular posts based on most commented.', 'balsacentral' ) );
		$this->WP_Widget('balsacentral-popular-posts', __( 'balsacentral Popular Posts', 'balsacentral' ), $widget_ops);
		$this->alt_option_name = 'balsacentral_popular_entries';
	...
	function widget($args, $instance) {
		...
		ob_start();
		extract($args);
		$title = apply_filters('widget_title', empty($instance['title']) ? __( 'Popular', 'balsacentral' ) : $instance['title']);
	...
	function update( $new_instance, $old_instance ) {
		...
		if ( isset($alloptions['balsacentral_popular_entries']) )
		delete_option('balsacentral_popular_entries');
		return $instance;
	}
