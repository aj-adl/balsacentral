...
class balsacentral_Social_Widget extends WP_Widget {
	function balsacentral_Social_Widget() {
		$widget_ops = array( 'classname' => 'balsacentral_social', 'description' => __( 'A social networking icons widget.', 'balsacentral') );
		$this->WP_Widget( 'balsacentral-social', __( 'balsacentral Social Icons', 'balsacentral' ), $widget_ops );
	}
	...
	function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('twitter'); ?>"><?php _e( 'Twitter', 'balsacentral' ); ?></label>
            ...
            <br />
            <small><?php _e( 'Full URL of Twitter profile', 'balsacentral' ); ?>
            </small>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('facebook'); ?>"><?php _e( 'Facebook', 'balsacentral' ); ?></label>
            ...
            <br />
            <small><?php _e( 'Full URL of Facebook profile', 'balsacentral' ); ?>
            </small>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('in'); ?>"><?php _e( 'LinkedIn', 'balsacentral' ); ?></label>
            ...
            <br />
            <small><?php _e( 'Full URL to LinkedIn Profile', 'balsacentral' ); ?></small>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('gplus'); ?>"><?php _e( 'Google+', 'balsacentral' ); ?></label>
            ...
            <br />
            <small><?php _e( 'Full URL to Google+ Profile', 'balsacentral' ); ?></small>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('dribble'); ?>"><?php _e( 'Dribble', 'balsacentral' ); ?></label>
            ...
            <br />
            <small><?php _e( 'Full URL to Dribble', 'balsacentral' ); ?>
            </small>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('forrst'); ?>"><?php _e( 'Forrst', 'balsacentral' ); ?></label>
            ...
            <br />
            <small><?php _e( 'Full URL to Forrst Profile', 'balsacentral' ); ?>
            </small>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('flickr'); ?>"><?php _e( 'Flickr', 'balsacentral' ); ?></label>
            ...
            <br />
            <small><?php _e( 'Full URL of Flickr Photostream', 'balsacentral' ); ?>
            </small>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('deviant'); ?>"><?php _e( 'DeviantArt', 'balsacentral' ); ?></label>
            ...
            <br />
            <small><?php _e( 'Full URL to DeviantArt Profile', 'balsacentral' ); ?>
            </small>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('vimeo'); ?>"><?php _e( 'Vimeo', 'balsacentral' ); ?></label>
            ...
            <br />
            <small><?php _e( 'Full URL to Vimeo Profile', 'balsacentral' ); ?>
            </small>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('utube'); ?>"><?php _e( 'YouTube', 'balsacentral' ); ?></label>
            ...
            <br />
            <small><?php _e( 'Full URL to YouTube Profile', 'balsacentral' ); ?>
            </small>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('pint'); ?>"><?php _e( 'Pinterest', 'balsacentral' ); ?></label>
            ...
            <br />
            <small><?php _e( 'Full URL to Pinterest', 'balsacentral' ); ?>
            </small>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('rss'); ?>"><?php _e( 'RSS', 'balsacentral' ); ?></label>
            ...
            <br />
            <small><?php _e( 'Optional RSS URL. If left blank, default rss2 URL will be used.', 'balsacentral' ); ?>
            </small>
        </p>
	<?php
	}
