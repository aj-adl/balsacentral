...
global $bcent_hide_secondary, $bcent_footer_left, $bcent_footer_right, $bcent_layout;
if ( is_active_sidebar( 'secondary-column-1' ) || is_active_sidebar( 'secondary-column-2' ) || is_active_sidebar( 'secondary-column-3' ) || is_active_sidebar( 'secondary-column-4' ) || is_active_sidebar( 'secondary-column-5' ) ) {
	...
	elseif ( is_single() ) {
		...
		$hide_secondary = $bcent_hide_secondary;
	}
...
<div id="footer" role="contentinfo">
    <div class="wrap clearfix">
        <div class="notes_left"><?php echo stripslashes($bcent_footer_left); ?></div><!-- .notes_left -->
        <div class="notes_right"><?php echo stripslashes($bcent_footer_right); ?></div><!-- .notes_right -->
    </div><!-- #footer wrap -->
</div><!-- #footer -->
</div> <!-- #container -->

<div class="top_btn"><a href="#" title="<?php _e( 'Scroll to top', 'balsacentral' ); ?>"></a></div><!-- .top_btn -->
<?php wp_footer(); ?>
</body>
</html>