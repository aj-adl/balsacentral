...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '3.1.0', __( 'WooCommerce Tab Manager', 'woocommerce-tab-manager' ), __FILE__, 'init_woocommerce_tab_manager', array( 'minimum_wc_version' => '2.1', 'backwards_compatible' => '3.1.0' ) );
